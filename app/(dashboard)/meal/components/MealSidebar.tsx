...
import { ListTree, Apple, Utensils } from 'lucide-react';
...
export default function MealSidebar({ tables, selectedTable, onSelectTable }: MealSidebarProps) {
  return (
        ...
        {tables.map(table => {
          ...
          return (
            <button
              ...
              className={`w-11 lg:w-auto h-11 lg:h-auto text-left px-0 lg:px-3 py-2 rounded-xl font-medium transition-colors flex items-center justify-center lg:justify-start gap-2.5 cursor-pointer ${isActive
